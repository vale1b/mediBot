...
const Mediplan = () => {
  return (
    <div
      id="plan"
      className=" min-h-[75vh] flex items-center justify-center bg-celeste my-20"
    >
      <div className="bg-primary w-7/12 max-w-[400px] my-10 rounded-lg flex flex-col py-5 px-10">
        ...
        <p className="text-center text-white font-medium text-xl py-8">
          <span className="text-3xl">$30</span>/mes
        </p>
