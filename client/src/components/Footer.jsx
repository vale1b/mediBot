  ...
  return (
    <div>
        ...
        <div className='bg-secondary flex items-center justify-between py-4 px-2 lg:px-10 mx-auto'>
            ...
            <div>
               <FontAwesomeIcon className='text-2xl pr-2 text-white drop-shadow-2xl cursor-pointer' icon={faCircleXmark} />
               <FontAwesomeIcon className='text-2xl pr-2 text-[#0077B5] drop-shadow-2xl cursor-pointer' icon={faLinkedin} />
               <FontAwesomeIcon className='text-2xl pr-2 text-blue-700 drop-shadow-2xl cursor-pointer' icon={faSquareFacebook} />
               <FontAwesomeIcon className='text-2xl pr-2 text-white drop-shadow-2xl cursor-pointer' icon={faSquareInstagram} />
            </div>
        </div>
    </div>
  )
