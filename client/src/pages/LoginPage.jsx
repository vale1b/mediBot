...
const LoginPage = () => {
  return (
    <div className='min-h-screen bg-primary flex flex-col items-center justify-center'>
        ...
        <form className='bg-white w-7/12 max-w-[370px] min-w-[320px] rounded-3xl py-2 px-4'>
            ...
            <input className='w-full bg-gray-300 py-2 rounded-3xl px-3 placeholder:text-gray-400 placeholder:font-bold' 
            type="text" name="email" id="email" placeholder='Ingresa tu correo aqui' />
            <label className='block font-bold py-2 ml-2 text-primary' htmlFor="password">Contraseña</label>
            <input className='w-full bg-gray-300 py-2 rounded-3xl px-3 placeholder:text-gray-400 placeholder:font-bold' 
            type="password" name="password" id="password" placeholder='Ingresa tu contraseña aqui' />
            ...
            <button className='bg-secondary tracking-wide text-white font-bold w-11/12 block mx-auto py-2 my-2 rounded-3xl hover:bg-primary' type="submit">iniciar sesión</button>
            <p className='text-black mx-4 my-3 text-sm font-bold flex justify-center '>Aun no tienes cuenta? 
                 <Link className='ml-2 hover:underline hover:decoration-solid pb-1 hover:underline-offset-4' to={'/register'}>Registrate aqui</Link>
            </p>
